...
#if (ESP8266_1M != 1)
/***********************************************************
*  Function: ws_db_set_mac_addr
*  Input: 
*  Output: 
*  Return: OPERATE_RET
***********************************************************/
__TUYA_WS_DB_EXT \
OPERATE_RET ws_db_set_mac_addr(IN CONST CHAR *mac_str);

/***********************************************************
*  Function: ws_db_get_mac_addr
*  Input: 
*  Output: 
*  Return: OPERATE_RET
***********************************************************/
__TUYA_WS_DB_EXT \
OPERATE_RET ws_db_get_mac_addr(OUT CHAR *mac_str);
#endif
...
/***********************************************************
*  Function: ws_db_set_test_key
*  Input: 
*  Output: 
*  Return: OPERATE_RET
***********************************************************/
OPERATE_RET ws_db_set_test_key(IN CONST BOOL test_key);

/***********************************************************
*  Function: ws_db_get_test_key
*  Input: 
*  Output: 
*  Return: OPERATE_RET
***********************************************************/
OPERATE_RET ws_db_get_test_key(OUT BOOL *test_key);
