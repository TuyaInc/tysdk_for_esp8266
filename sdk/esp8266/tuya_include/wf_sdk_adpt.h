...
/***********************************************************
*  Function: tuya_wifi_station_set_hostname
*  input: hostname  
*  input: hostname_len
*  Return: OPERATE_RET
*  Note: must use this api in app_init 
***********************************************************/
__WF_SDK_ADPT_EXT \
OPERATE_RET ty_wifi_station_set_hostname(IN CONST CHAR* hostname,IN CONST UINT hostname_len);

/***********************************************************
* @brief  Set the maximum value of RF TX Power, unit : 0.25dBm.
*power : the maximum value of RF Tx Power, unit : 0.25dBm, range [0, 82].
* @return OPERATE_RET
*  Note: must use this api in pre_app_init 
***********************************************************/
__WF_SDK_ADPT_EXT \
OPERATE_RET ty_wifi_set_custom_max_power(UCHAR power);
