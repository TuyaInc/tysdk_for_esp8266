...
typedef struct {
	UINT time;	//Õ≥º∆ ±º‰
	UINT len;   //data≥§∂»
	DP_PROP_TP_E type; //dp¿‡–Õ
    DP_DATA_T_U data;  //dp ˝æ›
}STATS_DATA_S;
...
/***********************************************************
*  Function: ÈªòËÆ§‰ΩéÂäüËÄóÊ®°Âºè‰∏ãÔºåÂΩìËÆæÂ§áË¢´ÁßªÈô§ÂêéÔºåÊòØÂê¶ËøõÂÖ•‰ΩéÂäüËÄóÊ®°Âºè
*  Input:
*  Output:
*  Return: none
*  Note:   none
...
*  Input: type: ACK_NORMAL  π”√productid(≤˙∆∑id)º§ªÓ
*				ACK_OEM     π”√productkey(πÃº˛key)º§ªÓ
*  Output: 
*  Return: 
*  Note: default use ACK_NORMAL, 
*        must be called in app_init
*        ◊¢“‚:πÃº˛key «keyø™Õ∑µƒ,»Á "key......"£¨≤ª“™∏„¥Ì
***********************************************************/
__SMART_WF_FRAME_EXT \
